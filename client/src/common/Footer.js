        ...
        <footer className="sticky-footer bg-white">
            <div className="mr-5">
                <div className="text-right my-auto">
                    ...
                    <a href="https://github.com/tak-9/covid-19" target="_blank" rel="noopener noreferrer"><i className="fab fa-github"></i></a>
                    <br className="d-sm-none" />
                    <small className="ml-4">Share this site on</small> 
                    <br className="d-sm-none" />
